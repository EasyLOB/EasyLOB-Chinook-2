...
namespace Chinook.Mvc
{
    public partial class PlaylistController : BaseMvcControllerSCRUDApplication<PlaylistDTO, Playlist>
    {
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            dataResult.result = new List<PlaylistViewModel>();
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<PlaylistViewModel, PlaylistDTO, Playlist>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
