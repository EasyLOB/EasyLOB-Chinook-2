...
namespace Chinook.Mvc
{
    public partial class TrackController : BaseMvcControllerSCRUDApplication<TrackDTO, Track>
    {
        ...
        public ActionResult Index(int? masterAlbumId = null, int? masterGenreId = null, int? masterMediaTypeId = null)
        {
            ...
            try
            {
                IsOperation(trackCollectionModel.OperationResult);
            }
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<TrackViewModel, TrackDTO, Track>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
