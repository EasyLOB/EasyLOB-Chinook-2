                ...
                if (IsCreate(playlistTrackItemModel.OperationResult))
                {
                    if (IsValid(playlistTrackItemModel.OperationResult, playlistTrackItemModel.PlaylistTrack))
                    {
                        ...
                        if (Application.Create(playlistTrackItemModel.OperationResult, playlistTrackDTO))
                        {
                            ...
                            {
                                playlistTrackItemModel.OperationResult.InformationMessage =
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<PlaylistTrackViewModel, PlaylistTrackDTO, PlaylistTrack>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
