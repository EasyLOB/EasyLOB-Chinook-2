...
namespace Chinook.Mvc
{
    public partial class GenreController : BaseMvcControllerSCRUDApplication<GenreDTO, Genre>
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                if (IsIndex(genreCollectionModel.OperationResult))
                {
                ...
                if (IsCreate(genreItemModel.OperationResult))
                {
                    if (IsValid(genreItemModel.OperationResult, genreItemModel.Genre))
                    {
                        ...
                        if (Application.Create(genreItemModel.OperationResult, genreDTO))
                        {
                            ...
                            {
                                genreItemModel.OperationResult.InformationMessage =
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            dataResult.result = new List<GenreViewModel>();
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<GenreViewModel, GenreDTO, Genre>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
