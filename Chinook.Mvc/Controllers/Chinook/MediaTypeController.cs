        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            if (IsSearch())
            {
                try
                {
                    ...
                    data = ZViewHelper<MediaTypeViewModel, MediaTypeDTO, MediaType>.ToViewList(Application.Select(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
