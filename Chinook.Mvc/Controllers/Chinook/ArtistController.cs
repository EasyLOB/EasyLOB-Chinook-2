...
namespace Chinook.Mvc
{
    public partial class ArtistController : BaseMvcControllerSCRUDApplication<ArtistDTO, Artist>
    {
        ...
        public ActionResult DataSource(DataManager dataManager)
        {
            ...
            dataResult.result = new List<ArtistViewModel>();
            ...
            if (IsSearch(operationResult))
            {
                try
                {
                    ...
                    dataResult.result = ZViewHelper<ArtistViewModel, ArtistDTO, Artist>.ToViewList(Application.Search(operationResult, where, args.ToArray(), orderBy, dataManager.Skip, take));
