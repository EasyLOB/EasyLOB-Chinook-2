...
namespace Chinook.Mvc
{
    public class CustomerAPIController : BaseApiControllerApplication<CustomerDTO, Customer>
    {
        ...
        public CustomerAPIController(IChinookGenericApplicationDTO<CustomerDTO, Customer> application)
        {
        ...
        public IHttpActionResult GetCustomers()
        {
            ...
            try
            {
                return Ok<IEnumerable<CustomerDTO>>(Application.Select(operationResult,
        ...
        public IHttpActionResult PostCustomer(CustomerDTO customerDTO)
        {
            ...
            try
            {
                if (IsValid(operationResult, customerDTO))
                {
